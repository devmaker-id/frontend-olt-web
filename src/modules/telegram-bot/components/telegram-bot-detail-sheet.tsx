...
import { useTestTelegramBot } from '../hooks/use-test-telegram-bot'
import { useWebhookInfo } from '../hooks/use-webhook-info'
...
export function TelegramBotDetailSheet({
  ...
  const webhookInfoMutation = useWebhookInfo()
  const setWebhookMutation = useSetWebhook()
  ...
  return (
    ...
    >
      <SheetContent className="p-3 w-full sm:max-w-2xl overflow-y-auto">
        <SheetHeader>
          <SheetTitle>
            {bot.name}
          </SheetTitle>
        ...
        <div className="mt-6 space-y-4">
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <p>
                Bot ID: {bot.telegramBotId}
              </p>
              <p>
                Chat ID: {bot.defaultChatId ?? '-'}
              </p>
              <p>
